...
import {
  ...
  CONTACT_FIELDS,
  TRAVEL_FIELDS,
} from "../../utils/fields"; // field arrays to reduce HTML duplication
import { NotFound } from "../../components/NotFound/NotFound";
import { canUserEdit } from "../../utils/canUserEdit"; // checks if user is admin or HR
import "./UserDetails.scss";
import "./UserDetails.responsive.scss";
            ...
            <div className="user-profile__card">
              <div className="user-profile__avatar-wrapper">
                <img
                  ...
                  alt="profile"
                  className="user-profile__card-image"
                />
                {remote && (
                  <img
                    src="/assets/home.png"
                    alt="remote-badge"
                    className="user-profile__remote-badge"
                    style={{ display: "block" }}
                  />
                )}
              </div>

              <h1 className="user-profile__card-name">
              ...
              <button
                type="button"
                className="user-profile__card-copy"
              ...
              {canEdit && (
                <div className="user-profile__card-actions">
                  <button
                    type="button"
                    className={`user-profile__card-edit ${
                      isEditing ? "user-profile__card-edit--active" : ""
                    }`}
                    // if isEditing is true show save button else show edit button
                  ...
                  {/* if editing mode is enabled show cancel button */}
                  <button
                    type="button"
                    className="user-profile__card-cancel"
