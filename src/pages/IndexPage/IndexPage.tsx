...
import "./IndexPage.responsive.scss";
...
export const IndexPage = () => {
  ...
  const initialSearch = searchParams.get("searchTerm") || ""; // get serach term from url if it doesnt exist use empty string;
  ...
  const handleBasicSubmit = () => {
    ...
    if (term) {
      nextParams.set("searchTerm", term);
    } else {
      nextParams.delete("searchTerm");
    }
    setSearchParams(nextParams, { replace: true }); // replace old params with new ones
  };
  ...
  return (
    <>
      <div className="mobile-search-bar">
        <div className="mobile-search-bar__field">
          <img
      ...
      <main className="directory page--fade-in">
        <div className="directory__content">
          ...
          <div className="directory__results">
            ...
            {loadingUsers || loading ? (
              <div className="directory__empty-state">
                <h1>Loading...</h1>
              </div>
