...
export const SearchTabs = ({
  ...
  return (
    <div className={styles["search-panel"]}>
      <div className={`${styles["search-panel__tabs"]} ${styles["directory__tabs"]}`}>
        <button
          className={`${styles["directory__tab"]} ${
            searchMode === "basic" ? styles["directory__tab--active"] : ""
          }`}
        ...
        <button
          className={`${styles["directory__tab"]} ${
            searchMode === "advanced" ? styles["directory__tab--active"] : ""
          }`}
      ...
      <div className={styles["search-panel__body"]}>
        {searchMode === "basic" ? (
          <div className={styles["search-panel__basic"]}>
            <input
              type="text"
            ...
            <button
              type="button"
              className={styles["search-panel__submit"]}
          ...
          <div className={`${styles["search-panel__advanced"]} ${styles["search-panel__advanced--active"]}`}>
            <div className={styles["search-panel__row"]}>
              <div className={styles["search-panel__field"]}>
            ...
            <div className={styles["search-panel__row"]}>
              <div className={`${styles["search-panel__field"]} ${styles["search-panel__field--wide"]}`}>
              ...
              <div className={`${styles["search-panel__field"]} ${styles["search-panel__field--narrow"]}`}>
